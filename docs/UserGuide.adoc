...
Phone numbers can have a plus sign at the start and have to be between 8-16 digits long
...
* `add Betsy Crowe pp/12345678 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend`
